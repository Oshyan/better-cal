...
- **Bound recurrence at the source**: require/inject a finish date with a smart default (12 weeks) instead of unbounded RRULEs; dissolves the "perpetual event silently stops at horizon" class entirely.
